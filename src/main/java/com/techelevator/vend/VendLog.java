...
public class VendLog {
    ...
    private final static DateTimeFormatter myFormatObj = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss a");
    ...
    public static void generateSalesReport(LocalDateTime startingTimestamp){
        String fileName = "logs/Log";
                fileName += new SimpleDateFormat("dd_MM_yyyy_HH_mm_ss").format(new Date());
                fileName += ".txt";
